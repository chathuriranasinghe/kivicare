...
// Images
import blog1 from '/assets/images/gallery/blog-1.png'
import blog2 from '/assets/images/gallery/blog-2.png'
import blog3 from '/assets/images/gallery/blog-3.png'
import blog4 from '/assets/images/gallery/blog-4.png'
import blog5 from '/assets/images/gallery/blog-5.png'
    ...
    <Offcanvas placement={`${themeSchemeDirection === "rtl" ? "start" : "end"}`} show={show && targetId === 'right-panel-toggle'} onHide={handleClose} target={`#${targetId}`} {...props}>
      ...
      <Offcanvas.Body className="px-5 d-flex flex-column justify-content-between">
        ...
        <div className="mb-5 pb-5 border-bottom">
          ...
          <p>170/A, Tiverton, Colombo Road, Peradeniya.</p>
          <p>info@wedameduraayurveda.com</p>
          <p>Phone : +(94) 773-674-288</p>
        </div>
        <div className="mb-5">
          <h4 className="mb-3">Follow Us:</h4>
          <SocialMedia isLabelHide={true} />
        </div>
        <p className="pt-3 mb-0 border-top">© {currentYear} All Rights Reserved by Pasyale Ayurveda Kandy (Peradeniya).</p>
      </Offcanvas.Body>
    </Offcanvas>
  )
}
