    ...
    <div className="iq-team-block team-overdetail position-relative p-2">
      ...
      <div className="share iq-team-social position-absolute">
          <ul className="list-inline list-unstyled p-0 m-0">
            <li className="mb-2">
                <Link className="position-relative bg-primary text-white d-flex justify-content-center align-items-center" to="https://www.facebook.com/pasyaleayurvedakandy">
                  <i className="fab fa-facebook-f"></i>
                </Link>
            </li>
            <li className="mb-2">
                <Link className="position-relative bg-primary text-white d-flex justify-content-center align-items-center" to="https://www.youtube.com/@PasyaleAyurveda">
                  <i className="fab fa-youtube"></i>
                </Link>
            </li>
            <li>
                <Link className="position-relative bg-primary text-white d-flex justify-content-center align-items-center" to="https://wa.me/94773674288">
