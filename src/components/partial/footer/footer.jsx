...
const Footer = memo((props) => {
    ...
    const usefulLink = [
        ...
        {
            LinkTitle: "service",
            LinkUrl: "./service/januwasthi"
        },
        {
            LinkTitle: "Team",
            LinkUrl: "./doctor-details"
        },
        {
    ...
    const workingDay = [
        {
            ...
            dayValue: "9:00 - 6:00 pm"
        },
        {
            dayLabel: "Saturday",
            dayValue: "9:00 - 7:00 pm"
        },
        {
            dayLabel: "Sunday",
            dayValue: "9:00 - 2:00 pm"
        },
        {
            dayLabel: "Friday",
            dayValue: "Closed"
                    ...
                    <Row>
                        <Col lg="4" md="6" className="mb-5 mb-lg-0">
                            <div className="pe-lg-5">
                                ...
                                <p className=" mt-2 mb-4">Inspired by 75 years of traditional medicine, Dr. D.C. Ganegoda shares health insights from Pasyale Vedamadura's 25 years of expertise. Stay informed, subscribe today!</p>
                            ...
                            <ul className="p-0 m-0 list-unstyled">
                                <li className="mb-3">
                                    <a className="d-flex gap-3" href="tel:+0123456789">
                                        ...
                                        <span className="text-body">+ (94) 773-674-288</span>
                                    </a>
                                </li>
                                <li className="mb-3">
                                    <a className="d-flex gap-3" href="mailto:support@example.com">
                                        ...
                                        <span className="text-body">info@wedameduraayurveda.com</span>
                                    </a>
                                </li>
            ...
            <div className="footer-bottom bg-primary-subtle border-top text-body">
                <Container className="py-4">
                    <div className="text-center ">
                        <p className="mb-0">© {currentYear} Pasyale Wedamedura All Rights Reserved.
                        </p>
                        <p className="mb-0">
                            <a href="http://rtechsl.com/" target="_blank" rel="noopener noreferrer">
                                Developed by R- Tech Solutions Team
                            </a>
                        </p>
