                            ...
                            <div className={`navbar-collapse ${show1 === true ? "collapse show" : "collapse"}`} id="navbarSupportedContent">
                                <ul className="navbar-nav align-items-center ms-auto mb-2 mb-xl-0">
                                    ...
                                    <Dropdown as="li" className="nav-item pe-3 me-3">
                                        ...
                                        <Dropdown.Menu className="p-3 sub-drop dropdown-menu-end" aria-labelledby="cart-drop">
                                    ...
                                    <Dropdown as="li" className="nav-item">
                                        <Dropdown.Toggle
                                            ...
                                            >
                                                <div className="btn-inner btn-icon btn-sm position-relative">   
                                                    <svg className="user-icons" xmlns="http://www.w3.org/2000/svg" width="20"
                                                        height="21" viewBox="0 0 20 21" fill="none">
                                                        <mask maskUnits="userSpaceOnUse" x="3" y="12"
                                                        width="14" height="7">
                                                        <path fillRule="evenodd" clipRule="evenodd"
                                                        ...
                                                        <mask maskUnits="userSpaceOnUse" x="5" y="1"
                                                        width="10" height="10">
                                                        <path fillRule="evenodd" clipRule="evenodd"
                                        ...
                                        <Dropdown.Menu
                                            className="dropdown-menu dropdown-menu-end dropdown-user"
