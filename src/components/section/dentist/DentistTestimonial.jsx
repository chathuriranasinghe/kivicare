...
export default function DentistTestimonial() {
  ...
  return (
    <div className="position-relative section-padding rtl-image-flip" style={{background: `url(${testimonialBg})`, backgroundRepeat: 'no-repeat',backgroundSize: 'cover', backgroundPosition: 'right center'}}>
