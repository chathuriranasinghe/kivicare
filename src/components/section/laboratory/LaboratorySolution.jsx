  ...
  return (
    <div className="section-padding pb-0">
        <Container>
          ...
          <div className="tab-bottom-bordered tab-border-botton-style-2 border-0 mb-5">
            <Tabs defaultActiveKey="lab-tab-1" id="uncontrolled-tab-example" className="mb-3 justify-content-lg-between justify-content-center gap-3 bg-transparent">
