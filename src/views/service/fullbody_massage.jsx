...
// Images
import fullbody_massage from '/assets/images/service/fullbody_massage.png'
...
export default function FullbodyMassage() {
  return (
    <Fragment>
      <BreadCrumb title="Full Body Massage" />
            ...
            <Col className="mt-lg-0 mt-5">
              <div className="about-service">
                <div className="position-relative  d-flex justify-content-center align-items-center">
                  <Image src={fullbody_massage} className="img-fluid" alt="image" />
                ...
                <div className="iq-title-box mt-5 mb-0">
                  ...
                  <h3 className="iq-title iq-heading-title mb-2">
                    <span className="right-text text-capitalize fw-500">Full Body Massage </span>
                    <span className="left-text text-capitalize fw-light">Treatment</span>
                  </h3>
                  <p className="iq-title-desc text-body">
                    Our Full Body Massage therapy is designed to promote deep relaxation, relieve muscle tension, and improve overall well-being. Through skilled techniques and soothing pressure, this treatment targets key areas of the body to alleviate stress, reduce pain, and enhance circulation, leaving you feeling rejuvenated and refreshed.</p>
                </div>
                    ...
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <span>Relieves muscle tension and reduces soreness</span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                      ...
                      <li>
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Improves blood circulation and lymphatic flow</span>
                        </div>
                      </li>
                    </ul>
                  </Col>
                  <Col md="6" className="mt-md-0 mt-2">
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Enhances flexibility and reduces joint stiffness</span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Aids in pain relief from chronic conditions like back pain</span>
                        </div>
                      </li>
                      <li>
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Promotes better posture and reduces muscle fatigue</span>
                        </div>
                      </li>
                    </ul>
                  </Col>
                ...
                <div className="pt-5">
                  <Row className="mt-5 align-items-center">
                    <Col md="6">
                      ...
                      >
                        <h2 className="counterValue" style={{ margin: "0" }}>Rs. 6900</h2>
                    ...
                    <Col md="6" className="mt-md-0 mt-5">
                      <div>
                        <Progressbar progressTitle="Stress Reduction and Relaxation" progressValue="93" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Muscle Tension Relief" progressValue="84" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Pain Management and Flexibility" progressValue="90" />
                      </div>
                    </Col>
                  </Row>
                </div>
