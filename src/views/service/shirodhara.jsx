...
// Images
import shirodhara from '/assets/images/service/shirodhara.png'
...
export default function Shirodhara() {
  return (
    <Fragment>
      <BreadCrumb title="Shirodhara Treatment" />
            ...
            <Col className="mt-lg-0 mt-5">
              <div className="about-service">
                <div className="position-relative d-flex justify-content-center align-items-center">
                  <Image src={shirodhara} className="img-fluid" alt="image" />
                ...
                <div className="iq-title-box mt-5 mb-0">
                  ...
                  <h3 className="iq-title iq-heading-title mb-2">
                    <span className="right-text text-capitalize fw-500">Shirodhara </span>
                    <span className="left-text text-capitalize fw-light">Treatment</span>
                  </h3>
                  <p className="iq-title-desc text-body">
                    Shirodhara is an ancient Ayurvedic therapy that involves the gentle pouring of warm herbal oils or liquids onto the forehead, particularly targeting the "third eye" area. This deeply relaxing treatment is designed to calm the nervous system, relieve stress, improve mental clarity, and promote overall emotional well-being.</p>
                </div>
                    ...
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <span>Relieves stress, anxiety, and mental fatigue</span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                      ...
                      <li>
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Balances emotions and enhances overall mood</span>
                        </div>
                      </li>
                    </ul>
                  </Col>
                  <Col md="6" className="mt-md-0 mt-2">
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Promotes deep relaxation and rejuvenates the mind</span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                      ...
                      <li>
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Boosts hair and scalp health through herbal oils</span>
                        </div>
                      </li>
                    </ul>
                  </Col>
                ...
                <div className="pt-5">
                  <Row className="mt-5 align-items-center">
                    <Col md="6">
                      ...
                      >
                        <h2 className="counterValue" style={{ margin: "0" }}>Rs. 6000</h2>
                    ...
                    <Col md="6" className="mt-md-0 mt-5">
                      <div>
                        <Progressbar progressTitle="Stress and Anxiety Relief" progressValue="91" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Improved Sleep Quality" progressValue="84" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Mental Clarity and Focus" progressValue="75" />
                      </div>
                    </Col>
                  </Row>
                </div>
