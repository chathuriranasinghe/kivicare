...
// Images
import urowasthi from '/assets/images/service/urowasthi.png'
...
export default function Urowasthi() {
  return (
    <Fragment>
      <BreadCrumb title="Uro Wasthi" />
            ...
            <Col className="mt-lg-0 mt-5">
              <div className="about-service">
                <div className="position-relative d-flex justify-content-center align-items-center">
                  <Image src={urowasthi} className="img-fluid" alt="image" />
                ...
                <div className="iq-title-box mt-5 mb-0">
                  ...
                  <h3 className="iq-title iq-heading-title mb-2">
                    <span className="right-text text-capitalize fw-500">Uro Wasthi</span>
                    <span className="left-text text-capitalize fw-light">Treatment</span>
                  </h3>
                  <p className="iq-title-desc text-body">
                    Urologists are specialized doctors who focus on the urinary tract system and male reproductive health. They diagnose and treat conditions related to kidneys, bladder, ureters, urethra, and male reproductive organs.</p>
                </div>
                    ...
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <span>Treats urinary tract infections (UTIs)</span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Manages kidney stone treatments</span>
                        </div>
                      </li>
                      <li>
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Performs prostate health checkups</span>
                        </div>
                      </li>
                    </ul>
                  </Col>
                  <Col md="6" className="mt-md-0 mt-2">
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Specializes in urological surgeries</span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Performs bladder function tests</span>
                        </div>
                      </li>
                      <li>
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Treats male infertility issues</span>
                        </div>
                      </li>
                    </ul>
                  </Col>
                ...
                <div className="pt-5">
                  <Row className="mt-5 align-items-center">
                    ...
                    <Col md="6" className="mt-md-0 mt-5">
                      <div>
                        <Progressbar progressTitle="Kidney Stone Removal" progressValue="91" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Prostate Cancer Treatment " progressValue="84" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Bladder Control Therapy" progressValue="75" />
                      </div>
                    </Col>
                  </Row>
                </div>
