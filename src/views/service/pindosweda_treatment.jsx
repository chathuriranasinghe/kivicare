...
// Images
import pindosweda_treatment from '/assets/images/service/pindosweda_treatment.png'
...
export default function PindoswedaTreatment() {
  return (
    <Fragment>
      <BreadCrumb title="Pindosweda Treatment" />
            ...
            <Col className="mt-lg-0 mt-5">
              <div className="about-service">
                <div className="position-relative d-flex justify-content-center align-items-center">
                  <Image src={pindosweda_treatment} className="img-fluid" alt="image" />
                ...
                <div className="iq-title-box mt-5 mb-0">
                  ...
                  <h3 className="iq-title iq-heading-title mb-2">
                    <span className="right-text text-capitalize fw-500">Pindosweda </span>
                    <span className="left-text text-capitalize fw-light">Treatment</span>
                  </h3>
                  <p className="iq-title-desc text-body">
                    Pindosweda is an Ayurvedic therapy that uses warm medicated bags filled with herbal powders or oils, which are applied to the body. This treatment is known for its ability to alleviate muscle tension, improve circulation, and promote deep relaxation. It is particularly beneficial for reducing joint pain, relieving stress, and enhancing overall vitality and well-being.</p>
                </div>
                    ...
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <span>Alleviates muscle and joint pain                          </span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                  ...
                  <Col md="6" className="mt-md-0 mt-2">
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Enhances flexibility and reduces muscle stiffnesss</span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Boosts energy levels and vitality</span>
                        </div>
                      </li>
                      <li>
                        <div className="d-flex align-items-center gap-2">
                ...
                <div className="pt-5">
                  <Row className="mt-5 align-items-center">
                    ...
                    <Col md="6" className="mt-md-0 mt-5">
                      <div>
                        <Progressbar progressTitle="Pain Relief and Joint Mobility" progressValue="91" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Stress Reduction" progressValue="84" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Improved Circulation" progressValue="75" />
                      </div>
                    </Col>
                  </Row>
                </div>
