...
// Images
import wellness from '/assets/images/service/wellness.png'
...
export default function Wellness() {
  return (
    <Fragment>
      <BreadCrumb title="Special Wellness Package" />
            ...
            <Col className="mt-lg-0 mt-5">
              <div className="about-service">
                <div className="position-relative d-flex justify-content-center align-items-center">
                  <Image src={wellness} className="img-fluid" alt="image" />
                ...
                <div className="iq-title-box mt-5 mb-0">
                  ...
                  <h3 className="iq-title iq-heading-title mb-2">
                    <span className="right-text text-capitalize fw-500">Special Wellness Package </span>
                    <span className="left-text text-capitalize fw-light">Treatment</span>
                  </h3>
                  <p className="iq-title-desc text-body">
                    Our Special Wellness Package is designed to rejuvenate the mind and body with a combination of therapies. This holistic treatment promotes relaxation, reduces stress, and enhances overall well-being using traditional Ayurvedic methods.</p>
                </div>
                    ...
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <span>Shirodhara for stress relief</span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Full body relaxation therapy for deep muscle relaxation</span>
                        </div>
                      </li>
                      <li>
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Steambath for detoxification</span>
                        </div>
                      </li>
                    </ul>
                  </Col>
                  <Col md="6" className="mt-md-0 mt-2">
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Head massage to relieve tension</span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Foot massage to improve blood circulation</span>
                        </div>
                      </li>
                      <li>
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Face-pack with face massage for glowing skin</span>
                        </div>
                      </li>
                    </ul>
                  </Col>
                ...
                <div className="pt-5">
                  <Row className="mt-5 align-items-center">
                    <Col md="6">
                      ...
                      >
                        <h2 className="counterValue" style={{ margin: "0" }}>Rs. 16900</h2>
                        <h5 className="counterText" style={{ margin: "10px 0 0" }}>Duration: 180 min</h5>
                      </div>
                    ...
                    <Col md="6" className="mt-md-0 mt-5">
                      <div>
                        <Progressbar progressTitle="Stress Relief through Shirodharan" progressValue="91" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Full Body Relaxation Therapy" progressValue="84" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Detoxification via Steambath" progressValue="75" />
                      </div>
                    </Col>
                  </Row>
                </div>
