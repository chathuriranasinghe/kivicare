...
// Images
import kasiwasthi from '/assets/images/service/kasiwasthi.png'
...
export default function Kasiwasthi() {
  return (
    <Fragment>
      <BreadCrumb title="Kasi Wasthi" />
            ...
            <Col className="mt-lg-0 mt-5">
              <div className="about-service">
                <div className="position-relative d-flex justify-content-center align-items-center">
                  <Image src={kasiwasthi} className="img-fluid" alt="image" />
                ...
                <div className="iq-title-box mt-5 mb-0">
                  ...
                  <h3 className="iq-title iq-heading-title mb-2">
                    <span className="right-text text-capitalize fw-500">Kasi Wasthi </span>
                    <span className="left-text text-capitalize fw-light">Treatment</span>
                  </h3>
                  <p className="iq-title-desc text-body">
                    Kasi Wasthi is an effective Ayurvedic treatment focusing on relieving lower back pain, improving spinal health, and addressing Vata-related disorders. It involves retaining medicated warm oil on the lower back region to nourish tissues, strengthen muscles, and alleviate stiffness.
                  </p>
                </div>
                    ...
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          ...
                          <span>Relieves chronic lower back pain</span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Improves flexibility and spinal strength</span>
                        </div>
                      </li>
                      <li>
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Reduces inflammation and muscle stiffness</span>
                        </div>
                      </li>
                    </ul>
                  </Col>
                  <Col md="6" className="mt-md-0 mt-2">
                    <ul className="list-inline m-0">
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Balances the Vata dosha</span>
                        </div>
                      </li>
                      <li className="mb-2">
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Aids in sciatica and lumbar spondylosis recover</span>
                        </div>
                      </li>
                      <li>
                        <div className="d-flex align-items-center gap-2">
                          <span className="text-primary"><i className="fas fa-check"></i></span>
                          <span>Enhances blood circulation in the lower back region</span>
                        </div>
                      </li>
                    </ul>
                  </Col>
                ...
                <div className="pt-5">
                  <Row className="mt-5 align-items-center">
                    ...
                    <Col md="6" className="mt-md-0 mt-5">
                      <div>
                        <Progressbar progressTitle="Pain Management Therapy" progressValue="91" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Muscle Stiffness Relief" progressValue="84" />
                      </div>
                      <div className="mt-5">
                        <Progressbar progressTitle="Inflammation Reduction" progressValue="75" />
                      </div>
                    </Col>
                  </Row>
                </div>
