            ...
            <Col md="4">
              ...
              <div className="iq-title-box mb-0">
                ...
                <h5 className="iq-title iq-heading-title mt-3">
                  <span className="right-text text-capitalize ">170/A, Tiverton, Colombo Road, Peradeniya</span>
                </h5>
              </div>
            </Col>
            <Col md="4">
              ...
              <div className="iq-title-box mb-0">
                ...
                <h5 className="iq-title iq-heading-title mt-3">
                  <span className="right-text  ">info@wedameduraayurveda.com</span>
                </h5>
              </div>
            </Col>
            <Col md="4">
              ...
              <div className="iq-title-box mb-0">
                ...
                <h5 className="iq-title iq-heading-title mt-3">
                  <span className="right-text text-capitalize ">+ (94) 773-674-288
                  </span>
                </h5>
              </div>
            </Col>
              ...
              <Row>
                <Col lg="6">
                  <Form.Group className="mb-3 custom-form-field">
                    <Form.Control type="text" placeholder="First Name" className="mb-5" required />
                  </Form.Group>
                </Col>
                <Col lg="6">
                  <Form.Group className="mb-3 custom-form-field">
